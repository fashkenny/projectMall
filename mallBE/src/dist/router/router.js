...
router.route("/:userID/single-account").get(authController_1.viewOneAccount);
router.route("/:userID/delete").delete(authController_1.deleteAccount);
router
    .route("/create-account")
    .post(validatorHolder_1.default, authController_1.registerAccount);
router
    .route("/create-account-dispatcher")
    .post((0, validatorHolder_1.default)(validator_1.createAccountValidator), authController_1.registerDispatcherAccount);
